    ...
    <div class="container my-5 py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="display-3 text-white animated slideInLeft"><span class="fs-1">Welcome To</span><br>ZenkFood</h1>
                ...
                <a href="/register" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Daftar Sekarang!</a>
            </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <a class="btn btn-primary py-3 px-5 mt-2" href="/register">Daftar Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
